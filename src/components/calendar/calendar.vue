  ...
  <section class="wh_container">
    <div class="wh_content_all">
      ...
      <div class="wh_content">
        <div class="wh_content_item" v-for="tag in textTop" :key="tag+'tag'">
      ...
      <div class="wh_content">
        <div class="wh_content_item" v-for="(item,index) in list" @click="clickDay(item,index)" :key="item.date">
...
export default {
    ...
    futureDayHide: {
      /* eslint-disable */
            handler(val, oldVal) {
                ...
                this.futureDayHide2 = parseInt(val)
                this.getList(this.myDate)
            },
            /* eslint-enable */
      deep: true
  ...
  methods: {
    ...
    ChoseMonth: function (date, isChosedDay = true) {
      ...
      this.myDate = new Date(pageDate)
      this.$emit('changeMonth', timeUtil.dateFormat(this.myDate))
      if (isChosedDay) {
        this.getList(this.myDate, pageDate, isChosedDay)
      } else {
        this.getList(this.myDate)
      }
    },
    ...
    getList: function (date, chooseDay, isChosedDay = true) {
      ...
      for (let i = 0; i < arr.length; i++) {
        ...
        // 无法选中某天
        k.dayHide = t < this.agoDayHide || t > this.futureDayHide2
        if (k.isToday) {
          this.$emit('isToday', nowTime)
        }
        let flag = !k.dayHide && k.otherMonth === 'nowMonth'
        if (chooseDay && chooseDay === nowTime && flag) {
          this.$emit('choseDay', nowTime, this.myDate)
